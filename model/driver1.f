	  ...
	  call energy_balance_climate_model(.1, .2, )
	  contains
	  
	  
	  subroutine energy_balance_climate_model(seasons, snowball, tend, dt, rot, a, ecc, peri, 
...
c      seasons = .true.     !if .true. do seasons: otherwise do mean-annual
 ...
 c     pco2 = pco20              !initial co2 concentration for this run (bars)
